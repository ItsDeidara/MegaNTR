...
=============================================
- Max Money (unglitched)
- Max Money (Glitched)
- Infinite stamina(hold b)
- 99x of all items you own
- Infinite stamina
- 255 first yokai Max HP
- 255 first yokai techniques masterized
- 255 first yokai max stats
- 255 first yokai max strenght
- 255 first yokai max spirit
- 255 first yokai max defense
- 255 first yokai max speed
- Every Item x50
- Infinite crank-a-kai (more coins than 3 a
- Infinite crank-a-kai (more coins than 3 a
- Infinite Crank-a-kai
